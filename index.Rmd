...
topGrams <- c("one of", "a lot", "to be", "as well", "going to", "out of", "the end", "some of", "it was", "be able", "i want", "part of", "thanks for", "the rest", "a couple", "i have", "the fact", "the first", "this is", "i have")

freq <- c(2888, 2479, 1382, 1283, 1246, 1213, 1193, 1156, 1134, 1123, 1116, 1016, 1016, 921, 872, 861, 855, 849, 827, 814)

df <- data.frame(gram = topGrams, freq=freq)
```

```{r, echo=FALSE}
wordcloud(df$gram, df$freq, random.order=FALSE, colors=brewer.pal(4, "Dark2"), max.words = 100, rot.per= 0.35, scale=c(8,.3)) 
```
